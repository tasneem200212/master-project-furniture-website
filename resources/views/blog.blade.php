                     ...
                     <article class="postbox__item mb-50 transition-3">
                        ...
                        <div class="postbox__content">
                           ...
                           <h3 class="postbox__title">
                              <a href="{{route('blog-details')}}">Colour ideas for kitchen and dining spaces</a>
                           </h3>
               ...
               <div class="col-xxl-4 col-lg-4">
                  <div class="sidebar__wrapper bd-sticky pl-30">
                     ...
                     <div class="sidebar__widget mb-45">
                        ...
                        <div class="sidebar__widget-content">
                           <ul>
                              <li><a href="{{route('blog')}}">Business <span>10</span></a></li>
                              <li><a href="{{route('blog')}}">Cleaning <span>08</span></a></li>
                              <li><a href="{{route('blog')}}">Consultant <span>24</span></a></li>
                              <li><a href="{{route('blog')}}">Creative <span>37</span></a></li>
                              <li><a href="{{route('blog')}}">Technology <span>103</span></a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="sidebar__widget mb-45">
                           ...
                           <div class="sidebar__post">
                              <div class="rc__post d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{route('blog-details')}}"><img src="assets/imgs/blog/blog-11.jpg" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <h4 class="rc__post-title">
                                       <a href="{{route('blog-details')}}">Business meeting 2021 in San Francisco</a>
                                    </h4>
                                    <div class="rc__meta">
                                       <span>
                                          <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                              ...
                              <div class="rc__post d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{route('blog-details')}}"><img src="assets/imgs/blog/blog-12.jpg" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <h4 class="rc__post-title">
                                       <a href="{{route('blog-details')}}">Developing privacy user-centric apps</a>
                                    </h4>
                                    <div class="rc__meta">
                                       <span>
                                          <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                              ...
                              <div class="rc__post d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{route('blog-details')}}"><img src="assets/imgs/blog/blog-13.jpg" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <h4 class="rc__post-title">
                                       <a href="{{route('blog-details')}}">Starting and Growing Web Design in 2022</a>
                                    </h4>
                                    <div class="rc__meta">
                                       <span>
                                          <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
